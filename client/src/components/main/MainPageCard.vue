  ...
  <div class="flex flex-col w-5/12 mx-1">
    <div class="max-w-5xl px-10 py-6 my-4 bg-white rounded-lg shadow-md">
      <div class="flex items-center justify-between">
        <span class="font-light text-gray-600">{{ props.issue.createdAt }}</span>
        <div class="flex">
      ...
      <div class="mt-2">
        <div class="flex justify-between">
          <a :href="'/community/detail/'+props.issue.id" class="text-2xl font-bold text-gray-700 hover:text-gray-600">{{ props.issue.title.length>15? props.issue.title.substr(0, 15) + '....' : props.issue.title }}</a>
      ...
      <div class="flex items-center justify-between mt-4">
        <a class="font-bold text-sub-grn hover:underline hover:text-main-grn" :href="'/community/detail/'+props.issue.id">Read more</a>
        <div class="flex">
