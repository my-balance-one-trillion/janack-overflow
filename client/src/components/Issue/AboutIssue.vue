  ...
  <div v-if="isLoading" class="space-y-14">
    ...
    <div class="my-10 flex justify-between items-center">
      <div
        ...
        <div
            class="w-full py-3 px-6 m-auto bg-white rounded-3xl border border-gray-300 justify-between items-center inline-flex">
    ...
    <!--  stackoverflow  -->
    <div v-if="stackoverflow !== 0" class="my-14">
      <div class="">
