...
//                -> httpSecuritySessionManagementConfigurer.sessionCreationPolicy(SessionCreationPolicy.STATELESS));
        ...
        http.authorizeHttpRequests((authorizeRequests) ->
                        authorizeRequests
                                ...
                                .requestMatchers("/image/**", "/css/**", "/", "/login", "/logout", "/signup", "/mailPass", "/community/**", "/savings/**", "/main/**", "/issue/**", "/ws/**", "/chatrooms/**", "/message/**", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**").permitAll()
